...
public class FragmentAzul extends Fragment {
    ...
    //metodo para añadir texto a nuestra vista y añadir botones al manejador etc...
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        //para que cambie el texto del fragmento azul al entrar al fragmento
        View v = inflater.inflate(R.layout.fragment_azul, container, false);
        TextView azul = (TextView)v.findViewById(R.id.tvAzul);
        azul.setText(mParam1);

        Button buttonazul = (Button)v.findViewById(R.id.btnAzul);
        buttonazul.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getContext(),"Pulsado boton del fragmento azul", Toast.LENGTH_SHORT).show();
            }
        });
        return v;
    }
